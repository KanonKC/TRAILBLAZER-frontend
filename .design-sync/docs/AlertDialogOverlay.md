...
category: Overlays
---
`AlertDialogOverlay` is part of the **AlertDialog** family - backdrop (already included by AlertDialogContent). Render it inside the `AlertDialog` composition; it has no standalone use.
