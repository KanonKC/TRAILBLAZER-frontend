...
---
`AvatarFallback` is part of the **Avatar** family - initials/icon shown while loading or on error. Render it inside the `Avatar` composition; it has no standalone use.
