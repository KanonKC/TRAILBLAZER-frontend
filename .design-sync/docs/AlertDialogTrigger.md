...
category: Overlays
---
`AlertDialogTrigger` is part of the **AlertDialog** family - opens the dialog (`asChild` to use a Button). Render it inside the `AlertDialog` composition; it has no standalone use.
