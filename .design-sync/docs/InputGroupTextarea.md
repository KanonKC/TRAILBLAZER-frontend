...
category: Forms
---
`InputGroupTextarea` is part of the **InputGroup** family - the borderless Textarea inside the group. Render it inside the `InputGroup` composition; it has no standalone use.
