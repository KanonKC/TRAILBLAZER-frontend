...
category: Forms
---
`FieldLegend` is part of the **Field** family - fieldset heading (`variant="label"` for the smaller style). Render it inside the `Field` composition; it has no standalone use.
