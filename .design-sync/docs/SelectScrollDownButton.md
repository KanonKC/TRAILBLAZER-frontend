...
category: Forms
---
`SelectScrollDownButton` is part of the **Select** family - scroll affordance (already rendered by SelectContent). Render it inside the `Select` composition; it has no standalone use.
