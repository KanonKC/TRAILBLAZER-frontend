...
category: Overlays
---
`AlertDialogHeader` is part of the **AlertDialog** family - title/description stack (centred in `size="sm"`). Render it inside the `AlertDialog` composition; it has no standalone use.
