...
category: Actions
---
`DropdownMenuSubTrigger` is part of the **DropdownMenu** family - row that opens the submenu (chevron added). Render it inside the `DropdownMenu` composition; it has no standalone use.
