...
category: Layout
---
`CardAction` is part of the **Card** family - slot pinned to the header's top-right (badge, menu button). Render it inside the `Card` composition; it has no standalone use.
