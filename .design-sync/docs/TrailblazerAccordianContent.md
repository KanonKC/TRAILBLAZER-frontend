...
category: App
---
`TrailblazerAccordianContent` is part of the **TrailblazerAccordian** family - padded body. Render it inside the `TrailblazerAccordian` composition; it has no standalone use.
