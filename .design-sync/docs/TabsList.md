...
category: Navigation
---
`TabsList` is part of the **Tabs** family - the trigger bar (`variant`: `default` pill / `line` underline). Render it inside the `Tabs` composition; it has no standalone use.
