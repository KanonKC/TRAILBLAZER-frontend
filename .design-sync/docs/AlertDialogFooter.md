...
category: Overlays
---
`AlertDialogFooter` is part of the **AlertDialog** family - button row (stacked on mobile). Render it inside the `AlertDialog` composition; it has no standalone use.
