...
category: Overlays
---
`AlertDialogContent` is part of the **AlertDialog** family - the centred panel; renders the overlay and portal for you. Render it inside the `AlertDialog` composition; it has no standalone use.
