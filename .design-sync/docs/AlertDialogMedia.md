...
category: Overlays
---
`AlertDialogMedia` is part of the **AlertDialog** family - 64px muted icon tile above the title. Render it inside the `AlertDialog` composition; it has no standalone use.
