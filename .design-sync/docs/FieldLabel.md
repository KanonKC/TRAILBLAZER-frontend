...
category: Forms
---
`FieldLabel` is part of the **Field** family - the label (wrap a whole `Field` inside it to make a selectable card). Render it inside the `Field` composition; it has no standalone use.
