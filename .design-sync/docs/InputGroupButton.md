...
category: Forms
---
`InputGroupButton` is part of the **InputGroup** family - compact ghost Button for addons (`size`: `xs` `sm` `icon-xs` `icon-sm`). Render it inside the `InputGroup` composition; it has no standalone use.
