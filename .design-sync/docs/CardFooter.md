...
category: Layout
---
`CardFooter` is part of the **Card** family - bottom row (`flex items-center`); add `border-t` for a divider. Render it inside the `Card` composition; it has no standalone use.
