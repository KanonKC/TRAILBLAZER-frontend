---
name: create-new-widget-frontend
description: Scaffolds a complete frontend flow for a new widget in blaze-frontend: service layer, dashboard configuration page, and OBS overlay page. Use when user wants to add a new widget to the frontend, create a widget config page, or create a widget overlay page.
---
