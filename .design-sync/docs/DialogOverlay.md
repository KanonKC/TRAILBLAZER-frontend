...
category: Overlays
---
`DialogOverlay` is part of the **Dialog** family - backdrop (already included by DialogContent). Render it inside the `Dialog` composition; it has no standalone use.
