...
category: Overlays
---
`DialogContent` is part of the **Dialog** family - centred panel with the X close button; includes overlay + portal. Render it inside the `Dialog` composition; it has no standalone use.
