...
category: Layout
---
`CardHeader` is part of the **Card** family - top block; becomes a 2-column grid when a `CardAction` is present. Render it inside the `Card` composition; it has no standalone use.
