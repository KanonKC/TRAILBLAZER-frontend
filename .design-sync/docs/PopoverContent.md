...
category: Overlays
---
`PopoverContent` is part of the **Popover** family - the floating panel (portal + positioning built in). Render it inside the `Popover` composition; it has no standalone use.
