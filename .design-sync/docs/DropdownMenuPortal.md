...
category: Actions
---
`DropdownMenuPortal` is part of the **DropdownMenu** family - portal (already used by DropdownMenuContent). Render it inside the `DropdownMenu` composition; it has no standalone use.
