...
category: Widgets
---
`WidgetEnableStep` is part of the **WidgetStepper** family - step 1 preset: `เปิดใช้งานวิดเจ็ต` + `WidgetStatusControl`. Render it inside the `WidgetStepper` composition; it has no standalone use.
