...
category: Forms
---
`ComboboxInput` is part of the **Combobox** family - search input with trigger chevron (`showTrigger`, `showClear`). Render it inside the `Combobox` composition; it has no standalone use.
