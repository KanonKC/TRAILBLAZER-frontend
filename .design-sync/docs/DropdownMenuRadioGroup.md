...
category: Actions
---
`DropdownMenuRadioGroup` is part of the **DropdownMenu** family - single-choice group (`value`, `onValueChange`). Render it inside the `DropdownMenu` composition; it has no standalone use.
