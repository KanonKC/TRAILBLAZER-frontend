...
category: Actions
---
`DropdownMenuItem` is part of the **DropdownMenu** family - menu row: icon + text (+ `DropdownMenuShortcut`); `variant="destructive"`, `inset`. Render it inside the `DropdownMenu` composition; it has no standalone use.
