...
category: Actions
---
`DropdownMenuShortcut` is part of the **DropdownMenu** family - right-aligned muted hint text. Render it inside the `DropdownMenu` composition; it has no standalone use.
