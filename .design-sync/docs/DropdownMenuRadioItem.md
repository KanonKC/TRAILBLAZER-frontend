...
category: Actions
---
`DropdownMenuRadioItem` is part of the **DropdownMenu** family - row inside a RadioGroup (`value`). Render it inside the `DropdownMenu` composition; it has no standalone use.
