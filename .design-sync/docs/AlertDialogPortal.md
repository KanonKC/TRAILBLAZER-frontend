...
category: Overlays
---
`AlertDialogPortal` is part of the **AlertDialog** family - portal (already included by AlertDialogContent). Render it inside the `AlertDialog` composition; it has no standalone use.
