...
category: Overlays
---
`AlertDialogCancel` is part of the **AlertDialog** family - cancel Button (outline variant). Render it inside the `AlertDialog` composition; it has no standalone use.
