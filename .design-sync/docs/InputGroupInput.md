...
category: Forms
---
`InputGroupInput` is part of the **InputGroup** family - the borderless Input inside the group. Render it inside the `InputGroup` composition; it has no standalone use.
